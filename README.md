# Terraform AWS EKS Cluster Role Module by KWAZI

Terraform Module for Creating a Standardized IAM Role for EKS Clusters on AWS
...
module "terraform_aws_role_eks_cluster" {
  source = "kwaziio/aws/role-eks-cluster"
}
```
